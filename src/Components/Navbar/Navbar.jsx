...
import VideoModal from './VideoModal'; // Asegúrate que esté bien la ruta
...
function Navbar() {
  ...
  const [showVideo, setShowVideo] = useState(false); // Modal F22
  ...
  return (
    <>
      ...
      {/* Modal de video para Nosotros */}
      {showVideo && (
        <VideoModal
          onClose={() => setShowVideo(false)}
          src="https://www.youtube.com/embed/r-keSTX_Pdo?autoplay=1"
          title="F-22 Raptor"
        />
      )}
    </>
